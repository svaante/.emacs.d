  ...
  (use-package project
    ...
    (defun project-switch-project-tab (dir)
      ...
      (let* ((name
        ...
        (cond
         (;; Switch on prefix arg
          current-prefix-arg (project-switch-project dir))
         (;; No project tab, create it
          (not index)
          (tab-bar-switch-to-tab name)
          (project-switch-project dir))
         (;; Current tab is project tab, DWIM
          (equal index (tab-bar--current-tab-index))
          (project-switch-project dir))
