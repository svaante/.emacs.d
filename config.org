...
#+begin_src emacs-lisp
  (use-package frame
    :general
    (leader-map
      "w" '(:ignore t :which-key "windows, tabs and frames")
...
#+begin_src emacs-lisp
  (use-package tab-bar
    ...
    :config
    (face-spec-set 'tab-bar '((t :inherit fringe)) 'face-defface-spec)
    (face-spec-set 'tab-bar-tab '((t :inherit mode-line)) 'face-defface-spec)
    (face-spec-set 'tab-bar-tab-inactive '((t :inherit mode-line-inactive))
                   'face-defface-spec))
#+end_src
...
#+begin_src emacs-lisp
  (use-package dape
    ...
    :general
    (dape-global-map
     (kbd "C-i") #'dape-stack-select-down
...
#+begin_src emacs-lisp
  (use-package gnus
    ...
    (advice-add 'gnus :before
                (defun gnus--display-buffer-advice (&rest _)
                  (thread-first gnus-group-buffer
