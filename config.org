...
#+begin_src emacs-lisp
  ...
  ;; (defun display-buffer-in-side-window-select (&rest args)
  ;;   (when-let ((window (apply 'display-buffer-in-side-window args)))
  ;;     (select-window window)))
  ;;
  ;; (defun display-buffer-reuse-window-select (&rest args)
  ;;   (when-let ((window (apply 'display-buffer-reuse-window args)))
  ;;     (select-window window)))
  ;;
  ;; (let ((popup-below '(display-buffer-at-bottom
  ;;                      . ((window-height . 0.4)
  ;;                         (dedicated . t))))
  ;;       (popup-left-slot '((display-buffer-reuse-window-select
  ;;                           display-buffer-in-side-window-select)
  ;;                          . ((side . right)
  ;;                             (slot . -1)
  ;;                             (window-width . 75)
  ;;                             (dedicated . t))))
  ;;       (popup-right-slot '((display-buffer-reuse-window
  ...
  ;;         `(((major-mode . help-mode) . ,popup-left-slot)
  ;;           ((major-mode . shell-mode) . ,popup-right-slot)
  ;;           ((major-mode . compilation-mode) . ,popup-right-slot)
  ;;           )))
#+end_src
