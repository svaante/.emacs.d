...
#+BEGIN_SRC emacs-lisp
  ...
  (defun org-capture-template-todays-pad ()
    (add-hook 'org-capture-mode-hook 'org-narrow-to-subtree t t)
    (org-capture-put :unnarrowed t)
    (beginning-of-buffer)
    (org-capture-put-target-region-and-position)
    (let ((headline (format-time-string "Pad %Y-%m-%d")))
  ...
  (defun consult-org-heading-notes ()
    (interactive)
    (find-fileorg-notes-file)
    (consult-org-heading))

  (evil-leader/set-key "on" 'consult-org-headline-notes)
#+END_SRC
* Completion
** Package company
#+BEGIN_SRC emacs-lisp
