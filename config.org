...
** Eshell
   #+begin_src emacs-lisp
     ...
     (use-package eshell
       ...
       (advice-add '+emacs/split-follow-window-horizontally
                   :after (lambda ()
                            (interactive)
                            (and (bound-and-true-p eshell-mode)
                                 (+eshell-create-and-rename))))
       (advice-add '+emacs/split-follow-window-vertically
                   :after (lambda ()
                            (interactive)
                            (and (bound-and-true-p eshell-mode)
                                 (+eshell-create-and-rename))))
