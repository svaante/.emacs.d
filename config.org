   ...
   #+begin_src emacs-lisp
     ...
     (use-package vertico-directory
       ...
       (evil-define-key '(insert normal) vertico-map
         (kbd "RET") (lambda () (interactive) (vertico-directory-enter))
         (kbd "DEL") (lambda () (interactive) (vertico-directory-delete-char))
         (kbd "M-DEL") (lambda () (interactive) (vertico-directory-delete-word))))
