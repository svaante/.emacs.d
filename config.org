   ...
   #+begin_src emacs-lisp
     ...
     (defun +magit-there (file)
       ...
       (let* ((default-directory (file-name-directory
                                  (expand-file-name
                                   (substitute-in-file-name file))))
              (buf (magit-status default-directory)))
...
** Dtache
 #+begin_src  emacs-lisp
   ...
   (use-package dtache-eshell
     :straight (dtache-eshell :type git :host gitlab :repo "niklaseklund/dtache")
     :after dtache
     :config
     (define-key embark-dtache-map "e" '+dtache-new-eshell-attach)
   ...
   (use-package dtache-consult
     :straight (dtache-consult :type git :host gitlab :repo "niklaseklund/dtache")
     :after dtache
     :config
