...
#+BEGIN_SRC emacs-lisp
  ...
  (leader-key "on" 'consult-org-heading-notes)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun minibuffer-insert-selection ()
    (when-let* ((_ (find this-command minibuffer-insert-commands))
...
#+begin_src  emacs-lisp
  ...
  (use-package dtache-consult
    ...
    :after dtache
    :config
    (leader-key "dd" 'dtache-consult-session))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (leader-key "wl" 'locked-window-buffer-mode)
#+end_src
...
#+begin_src emacs-lisp
  (use-package axe
    ...
    (leader-key "cl" 'axe-logs-describe-log-groups-with-comp))
#+end_src
