...
#+begin_src emacs-lisp
  (use-package cape
    ...
    ;; Add history to shell completion
    (advice-add #'shell-completion-vars :after
                (defun cape-shell-completion-vars (&rest _)
                  (setq-local completion-at-point-functions
                              `(,(cape-capf-super #'comint-completion-at-point #'cape-history))))))
#+end_src
