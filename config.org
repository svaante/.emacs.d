...
#+begin_src emacs-lisp
  (use-package emacs
    :hook
    (prog-mode . (lambda () (setq indicate-buffer-boundaries t)))
    (text-mode . (lambda () (setq indicate-buffer-boundaries t)))
    (conf-mode . (lambda () (setq indicate-buffer-boundaries t))))
#+end_src
