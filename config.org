...
** Themes
#+begin_src emacs-lisp
  (use-package consult--theme-history :ensure t)

  ;; Avoiding customize at all cost?
  (eval-after-load "consult.el"
...
*** GDB - Until DAP moves into =gdb-multiarch=
#+begin_src emacs-lisp
  (use-package gdb-mi
    :custom
...
#+begin_src emacs-lisp
  (use-package calendar
    ...
    (calendar-intermonth-text
     '((thread-last (list month day year)
