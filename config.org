...
#+BEGIN_SRC emacs-lisp
  ...
  (defun org-headline--register-completion-functions-h ()
    (add-hook 'completion-at-point-functions 'org-headline-link-complete-everywhere nil t))

  (add-hook 'org-mode-hook #'org-headline--register-completion-functions-h)
#+END_SRC
* Completion
** Package company
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    ;; Use basic completion-styles with company
...
#+begin_src  emacs-lisp
  ...
  (use-package dtache-eshell
    ...
    (define-key dtache-eshell-mode-map dtache-detach-key nil)
