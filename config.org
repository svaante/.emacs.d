...
** Detached
#+begin_src  emacs-lisp
  (defun +detache-project-compile ()
    (interactive)
    (project-with-directory t
      (call-interactively 'detached-compile)))

  (defun +detache-project-shell-command ()
    (interactive)
    (project-with-directory t
  ...
  (use-package detached
    ...
    :bind (;; Replace `async-shell-command' with `detached-shell-command'
           ...
           ;; Replace `compile' with `detached-compile'
           ([remap project-compile] . +detache-project-compile)
           ([remap project-shell-command] . +detache-project-shell-command)
