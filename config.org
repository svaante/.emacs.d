...
#+begin_src emacs-lisp
  (use-package process-history
    ...
    (defun process-history-consult (history-item)
...
#+begin_src emacs-lisp
  (use-package jinx
    ;; Using jinx to get the missspelling overlays, still using ispell to correct word.
    :straight t
    :config
    (global-jinx-mode))
  ...
  (use-package dape
    ...
    (setq dape-debug t
          ...
          '((dape-info-scope-mode dape-info-watch-mode)
            ...
            (dape-info-threads-mode dape-info-breakpoints-mode)))
